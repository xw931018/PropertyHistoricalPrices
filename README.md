This is a historical sold prices reader. It reads all historical sold prices from a website and returns a pandas data frame that summarizes the historical prices.
